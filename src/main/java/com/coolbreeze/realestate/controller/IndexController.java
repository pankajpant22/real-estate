...
public class IndexController {
		...
		while (iterator.hasNext()) {
			...
			if (prop.getSold() == 1) {
				...
				try {
					...
					// System.out.println(Days.daysBetween(dt1,
					// dt2).getDays()+"days");
					// System.out.println(Hours.hoursBetween(dt1,
					// dt2).getHours() %24 +"hours");
					// System.out.println(Minutes.minutesBetween(dt1,
					// dt2).getMinutes() %60 +"Minutes");
					// System.out.println(Seconds.secondsBetween(dt1,
	...
	public String searchProperty(
		...
		// StringBuilder("Select * from Property WHERE ");
...
//		String prices = properties.replaceAll("\\s+","");
//		String test = prices.substring(0,prices.length()-1);
//		String sort = request.getParameter("sType");
//		List<Property> propertyList = propertyService.searchPropertySort(sort,test);
//		model.addAttribute("propertyList", propertyList);
//		return "search-sort";
//	}
//	
...
//			Model model,@ModelAttribute("propertyList") List<Property> propertyList) {
//		model.addAttribute("propertyList", propertyList);
//		return "search";
//	}
